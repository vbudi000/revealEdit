...
void GitIndex::AddWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method add has thrown an error.")->ToObject();
...
{
  AddAll_CallbackBaton* baton =
    new AddAll_CallbackBaton(1);

  baton->path = path;
  baton->matched_pathspec = matched_pathspec;
  baton->payload = payload;

  return baton->ExecuteAsync((uv_async_cb) AddAll_callback_async);
}
...
void GitIndex::AddBypathWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method addByPath has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
void GitIndex::ClearWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method clear has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
void GitIndex::ConflictAddWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method conflictAdd has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
void GitIndex::ConflictCleanupWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method conflictCleanup has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
void GitIndex::ConflictRemoveWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method conflictRemove has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
void GitIndex::ReadTreeWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method readTree has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
int GitIndex::RemoveAll_callback_cppCallback (
  const char * path,     const char * matched_pathspec,     void * payload  )
{
  RemoveAll_CallbackBaton* baton =
    new RemoveAll_CallbackBaton(1);

  baton->path = path;
  baton->matched_pathspec = matched_pathspec;
  baton->payload = payload;

  return baton->ExecuteAsync((uv_async_cb) RemoveAll_callback_async);
}
...
void GitIndex::RemoveBypathWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method removeByPath has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
void GitIndex::RemoveDirectoryWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method removeDirectory has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
int GitIndex::UpdateAll_callback_cppCallback (
  const char * path,     const char * matched_pathspec,     void * payload  )
{
  UpdateAll_CallbackBaton* baton =
    new UpdateAll_CallbackBaton(1);

  baton->path = path;
  baton->matched_pathspec = matched_pathspec;
  baton->payload = payload;

  return baton->ExecuteAsync((uv_async_cb) UpdateAll_callback_async);
}
