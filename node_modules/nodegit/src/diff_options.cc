...
NAN_SETTER(GitDiffOptions::SetNotifyCb)
{
  ...
  if (callback) {
    ...
    wrapper->notify_cb.SetCallback(callback, throttle);
  }
...
{
  return static_cast<GitDiffOptions*>(baton->   payload  );
}
  ...
  const git_diff * diff_so_far,           git_diff_delta * delta_to_add,           const char * matched_pathspec,           void * payload        )
{
  ...
  return baton->ExecuteAsync((uv_async_cb) notify_cb_async);
}
...
void GitDiffOptions::notify_cb_async(uv_async_t* req, int status)
{
  ...
  Local<v8::Value> result = instance->notify_cb.GetCallback()->Call(4, argv);
...
NAN_SETTER(GitDiffOptions::SetProgressCb)
{
  ...
  if (callback) {
    ...
    wrapper->progress_cb.SetCallback(callback, throttle);
  }
  ...
  const git_diff * diff_so_far,           const char * old_path,           const char * new_path,           void * payload        )
{
  ...
  return baton->ExecuteAsync((uv_async_cb) progress_cb_async);
}

void GitDiffOptions::progress_cb_async(uv_async_t* req, int status)
{
  Nan::HandleScope scope;
  ...
  Nan::TryCatch tryCatch;
  Local<v8::Value> result = instance->progress_cb.GetCallback()->Call(4, argv);
