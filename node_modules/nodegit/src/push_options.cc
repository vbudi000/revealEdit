...
void GitPushOptions::ConstructFields()
{
  ...
  Local<Object> proxy_optsTemp = GitProxyOptions::New(
                                   &this->raw->proxy_opts,
                                   false
                                 )->ToObject();
  this->proxy_opts.Reset(proxy_optsTemp);

  Local<Object> custom_headersTemp = GitStrarray::New(
...
NAN_SETTER(GitPushOptions::SetProxyOpts)
{
  ...
  Local<Object> proxy_opts(value->ToObject());
...
NAN_SETTER(GitPushOptions::SetCustomHeaders)
{
  ...
  Local<Object> custom_headers(value->ToObject());
