...
void GitProxyOptions::InitializeComponent(Local<v8::Object> target)
{
...
NAN_SETTER(GitProxyOptions::SetCredentials)
{
  ...
  if (callback) {
    ...
    wrapper->credentials.SetCallback(callback, throttle);
  }
...
{
  return static_cast<GitProxyOptions*>(baton->    payload  );
}
  ...
  git_cred ** cred,           const char * url,           const char * username_from_url,           unsigned int allowed_types,           void * payload        )
{
  ...
  return baton->ExecuteAsync((uv_async_cb) credentials_async);
}

void GitProxyOptions::credentials_async(uv_async_t* req, int status)
{
  Nan::HandleScope scope;
  ...
  Local<v8::Value> result = instance->credentials.GetCallback()->Call(4, argv);
...
NAN_SETTER(GitProxyOptions::SetCertificateCheck)
{
  ...
  if (callback) {
    ...
    wrapper->certificate_check.SetCallback(callback, throttle);
  }
  ...
  git_cert * cert,           int valid,           const char * host,           void * payload        )
{
  ...
  return baton->ExecuteAsync((uv_async_cb) certificate_check_async);
}

void GitProxyOptions::certificate_check_async(uv_async_t* req, int status)
{
  Nan::HandleScope scope;
  ...
  Nan::TryCatch tryCatch;
  Local<v8::Value> result = instance->certificate_check.GetCallback()->Call(4, argv);
